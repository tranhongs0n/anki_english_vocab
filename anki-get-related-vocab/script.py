...
LLM_PROVIDER = os.getenv("LLM_PROVIDER") or "xah"

if LLM_PROVIDER == "local":
    LLM_API_URL = os.getenv("LLM_API_URL") or "http://127.0.0.1:8000/api/generate"
    LLM_API_KEY = ""
    LLM_MODEL = os.getenv("LLM_MODEL") or "fbb127bbb056c959"
elif LLM_PROVIDER == "google":
    LLM_API_URL = os.getenv("LLM_API_URL") or "https://generativelanguage.googleapis.com/v1beta/chat/completions"
